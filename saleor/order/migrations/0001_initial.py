    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(default='es', max_length=35)),
                ...
                ('shipping_price_net', django_prices.models.MoneyField(currency='ARS', decimal_places=2, default=0, editable=False, max_digits=12)),
                ('shipping_price_gross', django_prices.models.MoneyField(currency='ARS', decimal_places=2, default=0, editable=False, max_digits=12)),
                ('shipping_method_name', models.CharField(blank=True, default=None, editable=False, max_length=255, null=True)),
                ('token', models.CharField(max_length=36, unique=True)),
                ('total_net', django_prices.models.MoneyField(currency='ARS', decimal_places=2, default=0, max_digits=12)),
                ('total_gross', django_prices.models.MoneyField(currency='ARS', decimal_places=2, default=0, max_digits=12)),
                ('discount_amount', django_prices.models.MoneyField(currency='ARS', decimal_places=2, default=0, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price_net', django_prices.models.MoneyField(currency='ARS', decimal_places=2, max_digits=12)),
                ('unit_price_gross', django_prices.models.MoneyField(currency='ARS', decimal_places=2, max_digits=12)),
