...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('similar_products', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, size=None)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='similar', to='product.Product')),
            ],
        ),
        migrations.CreateModel(
            name='ProductType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_override', django_prices.models.MoneyField(blank=True, currency='ARS', decimal_places=2, max_digits=12, null=True)),
                ('attributes', django.contrib.postgres.fields.hstore.HStoreField(blank=True, default={})),
                ...
                ('cost_price', django_prices.models.MoneyField(blank=True, currency='ARS', decimal_places=2, max_digits=12, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='VariantImage',
